...
export default function ProjectsPage() {
  ...
  // Delete flow: which project is pending confirmation, and delete state
  ...
  async function confirmDelete() {
    ...
    try {
      const response = await fetch(
        `/api/projects/${encodeURIComponent(pendingDelete.slug)}`,
        {
          method: "DELETE",
          credentials: "include",
        }
      ...
      setProjects((prev) =>
        prev.filter((project) => project.slug !== pendingDelete.slug)
      );
          ...
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1.5 text-sm text-gray-500">
                Manage your completed and in-progress projects.
              </p>
            </div>
          ...
          <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="relative w-full sm:max-w-xs">
              <input
                ...
                placeholder="Search by title, category, client or slug..."
        ...
        {!loading && !error && projects.length === 0 && (
          <div className="rounded-2xl border border-dashed border-black/10 bg-white px-6 py-20 text-center">
            ...
            <p className="mx-auto mt-2 max-w-md text-sm text-gray-500">
              Create your first project to start showcasing your
              work.
            </p>
...
function ProjectCard({
  ...
  const metaLine = [project.client, project.location]
    .filter(Boolean)
    .join(" · ");
        ...
        <div className="mb-3 flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-xs text-gray-400">
              {metaLine || `Order: ${project.displayOrder}`}
            </p>
          </div>
        </div>
    ...
    >
      ...
      <div className="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
        ...
        <p className="mt-2 text-sm leading-6 text-gray-500">
          This will permanently remove this project from your website.
